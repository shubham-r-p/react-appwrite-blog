...
export class Service {
    ...
    async createPost({ title, slug, content, featuredImage, status, userId, documentId }) {

        console.log(`All post data --> `,title, slug, content, featuredImage, status, userId, documentId);
